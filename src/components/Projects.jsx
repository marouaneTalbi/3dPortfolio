...
import { calculateSizes, myProjects } from '../constants/index.js';
...
const Projects = () => {
  ...
  return (
    <section className="c-space p-20 ">
      <p className="head-text">Projets</p>

      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
        <div className="border border-black-300 flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
